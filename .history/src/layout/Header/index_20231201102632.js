...
import { HOMEPAGE } from 'src/utils/routes'
import { CATEGORIES } from 'src/utils/routes'
...
const Header = () => {
    ...
    const showSearch = useMemo(() => window.location.pathname === '/', [window.location.pathname]);
